...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-blue-800 via-blue-700 to-blue-900 text-white relative overflow-hidden">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 group">
                  ...
                  <p className="text-blue-100 text-sm">info@successhighschool.edu</p>
                </div>
      ...
      {/* Bottom Footer */}
      <div className="relative border-t border-blue-600/30 bg-blue-900/50 backdrop-blur-sm">
        <div className="px-6 py-6">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="flex flex-col md:flex-row items-center gap-4 text-sm text-blue-200">
                <p>&copy; 2025 SUCCESS High School. All rights reserved.</p>
